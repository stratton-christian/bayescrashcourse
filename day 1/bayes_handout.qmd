...
Now let's practice on some real data! We will use a subset of the data is Anna is working with. 

```{r}
weeds <- readRDS("bcc_dat.rds") %>% dplyr::select(Number_Tre:first3, Year_)
weeds
```
